!(function () {
  ...
  var Se,
    ...
    ke = !1;
  [].keys &&
    ('next' in (xe = [].keys()) ? (Ee = Ie(Ie(xe))) !== Object.prototype && (Se = Ee) : (ke = !0)),
    null == Se && (Se = {}),
    b(Se, Te) ||
      I(Se, Te, function () {
        return this;
    ...
    Xe = function (t, e, r, n, o, i, a) {
      ...
      if (
        (g &&
          ...
          ze !== Object.prototype &&
            u.next &&
            (Ie(u) !== ze && (qe ? qe(u, ze) : 'function' != typeof u[Ke] && I(u, Ke, He)),
            _e(u, l, !0))),
        o == $e &&
          d &&
          d.name !== $e &&
  ...
  var Lr = !o(function () {
    ...
    Cr = function (t, e, r) {
      ...
      return (
        (l[t] = f), kt({ global: !0, forced: f != s }, l), _e(f, t), a || r.setStrong(f, t, i), f
      );
    },
    Fr = function (t, e, r) {
        ...
        [
          ...
          function (t, o) {
            ...
            for (var h = 0, p = 0, d = []; p < u.length; ) {
              ...
              if (null === g || (v = Gi(ct(f.lastIndex + (Vi ? 0 : p)), u.length)) === h)
                p = Ci(u, p, c);
              else {
    ...
    cs = function (t, e) {
      if (e)
        for (var r, n, o = e.split('&'), i = 0; i < o.length; )
          (r = o[i++]).length &&
            ((n = r.split('=')), t.push({ key: os(n.shift()), value: os(n.join('=')) }));
    },
    fs = function (t) {
  ...
  var vs,
    ...
    Qs = function (t, e) {
      var r;
      return (
        2 == t.length && Ps.test(t.charAt(0)) && (':' == (r = t.charAt(1)) || (!e && '|' == r))
      );
    },
    Zs = function (t) {
      var e;
          ...
          case vc:
            if (((t.scheme = 'file'), '/' == i || '\\' == i)) c = gc;
              ...
              if (i == vs) (t.host = n.host), (t.path = n.path.slice()), (t.query = n.query);
                ...
                (t.host = n.host), (t.path = n.path.slice()), (t.query = ''), (c = Sc);
              else {
                if ('#' != i) {
  ...
  function Rl(t, e) {
    ...
    if (
      ...
      (this.method =
        ((n = (r = e.method || this.method || 'GET').toUpperCase()), Ol.indexOf(n) > -1 ? n : r)),
